...
N = 4  # Number of sections (what happens if this is odd, why?)
...
trueAns = 0.746824132812427
err = integral_approx - trueAns
perErr = ((integral_approx - trueAns)/trueAns)*100
print(f"Abs. Error = {err}")
print(f"Percent Error = {round(perErr,2)}%")