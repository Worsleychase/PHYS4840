...
loop_time = timeit.timeit("sum([x**2 for x in range(100000)])", setup=setup_code, number=100)
loop_time2 = timeit.timeit("sum([x**2 for x in range(100000)])", setup=setup_code, number=1000)
numpy_time = timeit.timeit("np.sum(my_array**2)", setup=setup_code, number=100)
numpy_time2 = timeit.timeit("np.sum(my_array**2)", setup=setup_code, number=1000)

print(f"Loop test time (100 iterations): ",  "%.5f"%loop_time,  " seconds")
print(f"Loop test time (1000 iterations): ",  "%.5f"%loop_time2,  " seconds\n")
print(f"Numpy test time (100 iterations): ",  "%.5f"%numpy_time,  " seconds")
print(f"Numpy test time (1000 iterations): ",  "%.5f"%numpy_time2,  " seconds")